...
**Goal:** Close the gap between what the user knows and what the current agent knows, enabling smart guidance later.
...
- If images exist without alt-text, explain that AI agents reading this doc won't be able to see the images without alt-text. Ask if they want alt-text generated. If so, request they paste each image into chat for descriptive alt-text generation.
...
**If no integrations are detected:** Suggest they check if their agent supports connectors or MCP integrations to allow pulling context from messaging apps and document storage directly.
...
- If user mentions team channels or shared documents:
  ...
  - If integrations not available: Explain lack of access. Suggest they enable MCP integrations or connectors if available, or paste the relevant content directly.
...
1. Open a fresh agent conversation (new session, no prior context)
